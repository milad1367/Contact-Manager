                      ...
                      <form>
                          <div className="modal-body">
                              <div className="form-group">
                                  ...
                                  <input type="text" className="form-control" id="fullName" aria-describedby="fullName" placeholder="Full Name" ref={this.inputName} /> {this.state.nameAlert ?
                              ...
                              <div className="form-group">
                                  ...
                                  <input type="tel" className="form-control" id="tel" aria-describedby="tel" placeholder="Phone Number" ref={this.inputPhone} /> {this.state.phoneAlert ?
                                  <div className="alert alert-danger" role="alert">
                              ...
                              <div className="form-group">
                                  ...
                                  <input type="email" className="form-control" id="email" aria-describedby="email" placeholder="Your Email" ref={this.inputEmail} /> {this.state.emailAlert ?
                                  <div className="alert alert-danger" role="alert">
                                      Email is required!
                                  </div> : null }
                              </div>
